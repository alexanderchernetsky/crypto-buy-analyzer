...
export const TokenForm: React.FC<TokenFormProps> = ({
	...
	return (
		<div
			className={`mt-6 mb-6 rounded-2xl border ${config.borderColor} ${config.backgroundColor} p-6 shadow-lg backdrop-blur-sm`}
		>
			<h2 className={`mb-5 text-xl font-bold ${config.titleColor}`}>{config.title}</h2>
