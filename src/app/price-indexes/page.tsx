        ...
        try {
            ...
            const analyzed = tokensWithData.map((inv ) => {
                ...
                if (priceRanges && priceRanges[inv.symbol]?.oneMonth) {
                    ...
                    oneMonthPriceIndex = calculatePriceIndex(currentPrice, oneMonthData?.min as number, oneMonthData?.max as number);
                ...
                if (priceRanges && priceRanges[inv.symbol]?.sixMonth) {
                    ...
                    sixMonthPriceIndex = calculatePriceIndex(currentPrice, sixMonthData?.min as number, sixMonthData?.max as number);
                }
                ...
                <div className="bg-slate-800 rounded-xl border border-slate-700 mt-6 overflow-x-auto">
                    <table className="w-full table-auto border-collapse">
                        ...
                        <tr>
                            ...
                            <th className="border-b border-slate-700 px-4 py-2 text-center text-sm font-semibold text-slate-300">6-M PI</th>
